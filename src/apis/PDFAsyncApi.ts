...
export interface PDFAsyncApiInterface {
    /**
     * Creates request options for createPdfAsync without sending the request
     * @param {CreateAsyncPdfRequest} createAsyncPdfRequest 
     * @throws {RequiredError}
     * @memberof PDFAsyncApiInterface
     */
    createPdfAsyncRequestOpts(requestParameters: CreatePdfAsyncRequest): Promise<runtime.RequestOpts>;
    ...
    /**
     * Creates request options for getPdfJob without sending the request
     * @param {string} jobId Async job ID (UUID returned by the create-async endpoint)
     * @throws {RequiredError}
     * @memberof PDFAsyncApiInterface
     */
    getPdfJobRequestOpts(requestParameters: GetPdfJobRequest): Promise<runtime.RequestOpts>;
    ...
    /**
     * Creates request options for listPdfJobs without sending the request
     ...
     * @memberof PDFAsyncApiInterface
     */
    listPdfJobsRequestOpts(requestParameters: ListPdfJobsRequest): Promise<runtime.RequestOpts>;
...
export class PDFAsyncApi extends runtime.BaseAPI implements PDFAsyncApiInterface {
     ...
     * Creates request options for createPdfAsync without sending the request
     */
    async createPdfAsyncRequestOpts(requestParameters: CreatePdfAsyncRequest): Promise<runtime.RequestOpts> {
    ...
    async createPdfAsyncRaw(requestParameters: CreatePdfAsyncRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateAsyncPdfResponse>> {
        const requestOptions = await this.createPdfAsyncRequestOpts(requestParameters);
     ...
     * Creates request options for getPdfJob without sending the request
     */
    async getPdfJobRequestOpts(requestParameters: GetPdfJobRequest): Promise<runtime.RequestOpts> {
    ...
    async getPdfJobRaw(requestParameters: GetPdfJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobStatusResponse>> {
        const requestOptions = await this.getPdfJobRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Creates request options for listPdfJobs without sending the request
     */
    async listPdfJobsRequestOpts(requestParameters: ListPdfJobsRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
    ...
    async listPdfJobsRaw(requestParameters: ListPdfJobsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobListResponse>> {
        const requestOptions = await this.listPdfJobsRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
